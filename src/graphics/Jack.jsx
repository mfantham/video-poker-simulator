          ...
          <g transform="translate(825.000000, 1100.000000)">
            ...
            >
              <mask id="react-mask-4" fill="white">
                <use xlinkHref="#background-circle"></use>
              </mask>
              <use
                id="Circle-Background"
                fill="#E6E6E6"
                xlinkHref="#background-circle"
              ></use>
              <g
            ...
            <g id="Mask"></g>
            <g strokeWidth="1" fillRule="evenodd" mask="url(#react-mask-5)">
              ...
              <g transform="translate(0.000000, 170.000000)">
                ...
                <g id="Shirt" transform="translate(32.000000, 29.000000)">
                  <mask id="react-mask-276" fill="white">
                    <use xlinkHref="#react-path-275"></use>
                  </mask>
                  <use
                    id="Clothes"
                    fill="#E6E6E6"
                    xlinkHref="#react-path-275"
                  ></use>
                  <g
                    id="Color/Palette/Black"
                    mask="url(#react-mask-276)"
                    fill="#262E33"
                  >
                    <g
              ...
              >
                <g id="Mouth/Smile" transform="translate(2.000000, 52.000000)">
                  ...
                  <mask id="react-mask-280" fill="white">
                    <use xlinkHref="#react-path-279"></use>
                  </mask>
                  <use
                    id="Mouth"
                    ...
                    fill="#000000"
                    fillRule="evenodd"
                    xlinkHref="#react-path-279"
                  ></use>
                  <rect
                    id="Teeth"
                    fill="#FFFFFF"
                    fillRule="evenodd"
                    mask="url(#react-mask-280)"
                    x="39"
                    y="2"
                    width="31"
                    height="16"
              ...
              <g id="Top" strokeWidth="1" fillRule="evenodd">
                ...
                <mask id="react-mask-227" fill="white">
                  <use xlinkHref="#react-path-229"></use>
                </mask>
                <g id="Mask"></g>
                <g id="Top/Short-Hair/Frizzle" mask="url(#react-mask-227)">
                  <g transform="translate(-1.000000, 0.000000)">
                    <mask id="hair-mask" fill="white">
                      <use xlinkHref="#react-path-228"></use>
                    </mask>
                    <use
                      id="Hair-Maks"
                      stroke="none"
